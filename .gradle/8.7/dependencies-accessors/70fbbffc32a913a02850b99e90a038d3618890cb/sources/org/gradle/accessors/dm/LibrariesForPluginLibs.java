...
/**
 * A catalog of dependencies accessible via the {@code pluginLibs} extension.
 */
@NonNullApi
public class LibrariesForPluginLibs extends AbstractExternalDependencyFactory {
    ...
    @Inject
    public LibrariesForPluginLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
    ...
    public static class AndroidPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>android.kotlin</b> with plugin id <b>org.jetbrains.kotlin.android</b> and
    ...
    public static class GooglePluginAccessors extends PluginFactory {
         ...
         * with version <b>1.9.22-1.0.17</b>
         * <p>
         * This plugin was declared in settings file 'settings.gradle.kts'
         */
